    ...
    public OpenAPI swaggerOpenAPI() {
        return new OpenAPI()
                ...
                .components(new Components()
                        ...
                        .addSchemas("MobilePhoneCertifiableSchema", getSchemaWithDifferentDescription(CertifiableFieldResourceString.class, "${swagger.model.user.workContact.mobilePhone}" ))
                        .addSchemas("TelephoneCertifiableSchema", getSchemaWithDifferentDescription(CertifiableFieldResourceString.class, "${swagger.model.user.workContact.telephone}" )));
